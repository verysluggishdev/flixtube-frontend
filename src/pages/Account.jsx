    ...
    <div className="content account-main">
      <div className='account-info'>
        <div className="channel-info">
          <img src="https://pbs.twimg.com/media/DpA1qojXUAAukgt.jpg" alt="" className="avatar" />
          <div className="flex-col">
            <h1 className="channel-name">Bruhman Memes & Clips</h1>
            <div className="flex-row">
            <p className="channel-id">@bruhman</p>
